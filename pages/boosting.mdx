...
<Steps>
    ...
    * Configure the `config.lua` to fit your server's needs (framework specific settings). Everything else can be adapted through the in game Admin Configuration menu. Visit [Configuration](/boosting/Config) for a full config source preview.
