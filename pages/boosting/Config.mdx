...
Config = {
    ...
    MarketEnabled = true,                                      -- Market functionality
    MaxActiveBoosts = 3,                                       -- Defines how many boosts can be done at the same time
    QuickProgressDefault = true,                               -- Quick progress visibility
    ...
    Hacks = {      -- Hacks range and cooldown per class by index
        [5] = {
            min = 8,
            max = 12,
            coolDown = 6000
    ...
    Classes = {
        ...
        },
        {
            ...
            mods = {
                ...
                always = {},
                wheels = { enabled = true, wheelType = 0 }
            }
        },
        {
            label = 'B',
