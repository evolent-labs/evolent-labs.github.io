...
description: Create your own mission steps and link them to missions in game.
icon: Route
---
...
## Create your own mission step

<Steps>
<Step>

### Create the server side step
...
### Register it in the server steps list
...
### Register it in the client steps list
