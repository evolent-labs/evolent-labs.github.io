---
title: Frameworks
description: Supported frameworks and how to customize a bridge.
icon: Blocks
---
...
| **Vehicle keys** | `qbx_vehiclekeys` | `qb-vehiclekeys` | Add your own | Built into ox_core |
| **Impound fee paid from** | Bank, then cash | Bank, then cash | Bank, then cash | `money` item (ox_inventory) |
